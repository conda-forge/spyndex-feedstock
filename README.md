...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/spyndex-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13964&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/spyndex-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `spyndex` can be installed with:

```
conda install spyndex
```

It is possible to list all of the versions of `spyndex` available on your platform with:
